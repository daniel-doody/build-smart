  ...
  return (
    <div>
      <div className='flex flex-col items-center justify-center min-h-screen from-gray-700 via-gray-800 to-gray-900 bg-gradient-to-br'>
        <div className='w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-white border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl'>
          <div className='pb-6'>
            <div className='flex flex-wrap justify-center'>
              <div className='flex justify-center w-full'>
                <div className='relative'>
                  {/* IMAGE */}
                  <img
                    src='https://i.ibb.co/pnNfVSJ/Untitled-design-3.png'
                    className='dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[130px]'
                  />
                </div>
              </div>
            </div>
                ...
                <div className='flex justify-center pt-8 pb-0 lg:pt-4'>
                  <div className='flex space-x-4'>
                    ...
                    <a
                      ...
                      href='https://www.github.com/daniel-doody'
                      rel='noopener'
                      aria-label='Daniel Doody on Github'
                      target='_blank'
                    >
                      <svg
                    ...
                    <a
                      className='p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary'
                      href='https://www.linkedin.com/in/daniel-doody/'
                      rel='noopener'
                      aria-label='Daniel Doody on Linkedin'
                      target='_blank'
                    >
                      <svg
                        className='w-6 h-6 overflow-visible fill-current'
              ...
              <div className='flex flex-wrap justify-center'>
                <div className='w-full px-4'>
                  <p className='mb-4 font-light leading-relaxed text-gray-600 dark:text-gray-400'>
                    Software Engineer, Kubernetes enthusiast, and lifelong
                    runner whose next goal is to finish a marathon on all seven
                    continents :)
                  </p>
                </div>
              </div>
